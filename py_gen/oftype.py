...
variable_elem_len_lists = {
    ...
    'list(of_tlv_t)': 'util.unpack_list_tlv',
    'list(of_bsn_table_entry_desc_stats_entry_t)': 'util.unpack_list_bsn_table_entry_desc_stats_entry',
    'list(of_bsn_table_entry_stats_entry_t)': 'util.unpack_list_bsn_table_entry_stats_entry',
    'list(of_bsn_table_desc_stats_entry_t)': 'util.unpack_list_bsn_table_desc_stats_entry',
    'list(of_bsn_table_bucket_stats_entry_t)': 'util.unpack_list_bsn_table_bucket_stats_entry',
}
