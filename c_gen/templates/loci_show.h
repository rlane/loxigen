...
#define LOCI_SHOW_u8_src_class_id(writer, cookie, val) LOCI_SHOW_u8(writer, cookie, val)
#define LOCI_SHOW_u8_dst_class_id(writer, cookie, val) LOCI_SHOW_u8(writer, cookie, val)
